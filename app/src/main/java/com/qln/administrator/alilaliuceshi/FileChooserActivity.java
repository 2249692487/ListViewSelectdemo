...
public class FileChooserActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSdcardRootPath = "/storage";//Environment.getExternalStorageDirectory().getAbsolutePath();// �õ�sdcardĿ¼
	...
	private AdapterView.OnItemClickListener mItemClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> adapterView, View view, int position,
			...
			if(fileInfo.isDirectory())   //点击项为文件夹, 显示该文件夹下所有文件
			    ...
			    intent.putExtra(VideoListActivity.EXTRA_FILE_CHOOSER , fileInfo.getFilePath());
